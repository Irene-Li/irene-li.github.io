...
summary: >-
  Using the zebrafish embryo, we show how the geometry of the fertilised egg patterns cell-cycle timing and the spatiotemporal onset of zygotic genome activation across the early embryo.
---
